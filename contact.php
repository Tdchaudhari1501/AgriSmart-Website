...
<body>
  <div class="container">
    <h1 class="h1-responsive clients-title text-center shadow-sm py-2">Talk to Devops</h1>
        ...
        <div class="col-sm-6">
          <div class="card align-items-center">
            <div class="card-body py-2">
              ...
              <form class="comment-form py-2" method="post" action="insertcontact.php">
                ...
                <div class="form-group py-2">
                  ...
                  <textarea name="textarea" placeholder="Talk to us here..." id="textarea" name="textarea" cols="23" rows="3"
                    required></textarea>
                </div>
        ...
        <div class="col-sm-6 opening-hours">
          <div class="container">
            ...
            <div class="content py-2 mx-2">
              <h6 class="h6-responsive"><span><i class="fa fa-clock-o" aria-hidden="true"></i> </span> Monday-Friday:
                08:00-16:00</h6>
              <h6 class="h6-responsive"><span><i class="fa fa-clock-o" aria-hidden="true"></i> </span> Weekends:
                09:00-13:00</h6>
              <h6 class="h6-responsive"><span><i class="fa fa-clock-o" aria-hidden="true"></i> </span> Public Holidays:
                10:00-16:00</h6>
            </div>
            ...
            <div class="socials py-2 mx-2">
              ...
              <hr>
              <h6 class="h6-responsive"><span> <i class="fa fa-envelope" aria-hidden="true"></i>
                </span>tusharchaudhari1501@gmail.com</h6>
              <h6 class="h6-responsive"><span> <i class="fa fa-phone" aria-hidden="true"></i> </span>7046274457</h6>
              <h6 class="h6-responsive"><span> <i class="fa fa-home" aria-hidden="true"></i> </span>LDCE-CAMPUS
